...
const Read = ({ bookshelfProps }) => {
  const { readBks, favBks, triggerRender, setTriggerRender, handleAction } =
    bookshelfProps;
  ...
  return (
    <div className="container">
      {readBks.length > 0 ? (
            ...
            <div key={book.id} className="book-item flex flex-column flex-sb">
              <div className="book-item-info text-center">
                ...
                <div className="flex flex-column">
                  ...
                  >
                    Mover para os Livros Não Lidos
                  </button>
        ...
        <p className="no-book-found fs-20 fw-6">Nenhum livro lido encontrado</p>
      )}
    </div>
  );
};
